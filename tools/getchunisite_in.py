...
for i in range(1001,1016):
  if(i == 1009 or i == 1015 or i == 1014): continue
  url = "https://location.am-all.net/alm/location?gm=104&lang=en&ct="+ str(i)
...
with open('./tools/store_data_chuni_in.json', 'w', encoding='utf-8') as f:
    f.write(json_output)
